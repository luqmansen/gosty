...
docker-worker: cleanup worker-bin
	...
	docker build -t localhost:32785/gosty-worker -f docker/Dockerfile-worker .
	docker push localhost:32785/gosty-worker

docker-fs: cleanup fs-bin
	#docker build -t luqmansen/gosty-fileserver -f docker/Dockerfile-fileserver .
	docker build -t localhost:32785/gosty-fileserver -f docker/Dockerfile-fileserver .
	docker push localhost:32785/gosty-fileserver
...
docker-api: cleanup api-bin
	...
	docker build -t localhost:32785/gosty-apiserver -f docker/Dockerfile-apiserver .
	docker push localhost:32785/gosty-apiserver
